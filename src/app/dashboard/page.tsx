...
import { Bell, Users, Image as ImageIcon, Video, FileText } from 'lucide-react';
...
const bottomTools = [
    ...
    { name: 'Catalogue', href: '/catalogue', icon: <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="15" y="12" width="18" height="24" rx="3" fill="#DBEAFE"/><path d="M19 19H29V21H19V19Z" fill="#60A5FA"/><path d="M19 24H29V26H19V24Z" fill="#93C5FD"/><path d="M19 29H25V31H19V29Z" fill="#93C5FD"/><rect x="29" y="16" width="8" height="10" rx="1" fill="#BFDBFE" transform="rotate(15 29 16)"/></svg> },
