...
const topTools = [
  ...
  { name: 'Visitors', href: '/visitors', icon: <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M13 28V26C13 24.9391 13.4214 23.9217 14.1716 23.1716C14.9217 22.4214 15.9391 22 17 22H23C24.0609 22 25.0783 22.4214 25.8284 23.1716C26.5786 23.9217 27 24.9391 27 26V28" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M20 18C22.2091 18 24 16.2091 24 14C24 11.7909 22.2091 10 20 10C17.7909 10 16 11.7909 16 14C16 16.2091 17.7909 18 20 18Z" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>, bgColor: 'bg-yellow-500' },
